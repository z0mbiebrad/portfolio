<div id="about" class="relative isolate overflow-hidden pt-[4.5rem]">
    ...
    <div class="flex flex-wrap text-black dark:text-white bg-white/60 dark:bg-black/40 sm:justify-center">
        <div class="w-full max-w-5xl mb-10 sm:w-11/12">
            <div class="container h-full mx-auto">
                <img src="{{ asset('images/family.png') }}"
                    alt="" class="object-cover object-top w-full h-48 my-16 sm:h-80">
                <header class="container h-full">
                    <div class="w-full">
                        <h1 class="mx-auto text-4xl font-bold sm:text-5xl lg:text-6xl w-fit">Hi! I'm <span class="text-orange-400 dark:text-indigo-400">Bradley
                                Evans</span>. <br>
                            It's nice to meet <span class="text-orange-400 dark:text-indigo-400">you</span>!</h1>
                        <div class="w-3/4 h-1 mx-auto my-12 bg-orange-400 dark:bg-indigo-400"></div>
                        <p class="px-5 mx-auto mb-12 text-xl font-semibold w-fit">I am a full stack web
                        ...
                        <div class="flex items-center justify-center mt-10 font-semibold gap-x-6 dark:text-white">
                            <a href="#examples"
                                class="flex border-b-2 border-black dark:border-white text-md gap-x-1">
                                <x-circle-stack />
                                Examples
                            </a>
                            <a href="#services"
